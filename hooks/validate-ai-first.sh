...
case "$FILE" in
  */raw/*|*/templates/*|*/_export/*|*/.obsidian/*|*/.git/*|*/.trash/*|*/sablony/*|*/log/*)
    exit 0 ;;
esac
...
# (vault_health.py already exempts _CLAUDE.md the same way).
case "$BASENAME" in
  _CLAUDE.md|CLAUDE.md|README.md) exit 0 ;;
esac
...
# cs-adaptace: em/en-dash and double quotes removed from the banned set -- they
# are correct Czech typography (pomlcka, uvozovky „"), not LLM substitution noise.
BANNED = {
